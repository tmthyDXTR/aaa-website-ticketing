...
const sampleSqlRows = [
...

    {
        ticket_id: "24",
        ticket_order_id: "134",
        ticket_paypal_id: "0VB564105D224081Y",
        ticket_type: "3TMC",
        ticket_name: "3 Tage mit Camping",
        ticket_security_code: "MJBNFM",
        ticket_price: "60",
        ticket_payed: "1",
        ticket_checked_in: "0",
        ticket_holder_email: "Hans123@gmx.de",
        ticket_checked_in_time: null,
        ticket_created_time: "2023-09-08 10:13:54",
        ticket_sent_time: null,
        ticket_url: null,
    },
    {
        ticket_id: "25",
        ...
        .then((ticketLinks) => {
            ...
            for (const key in ticketLinks) {
                if (ticketLinks.hasOwnProperty(key)) {
                    ...
                    console.log(
                        `Ticket ${key}: Security Code: ${securityCode}, Url: ${url}`
                    );
                }
            }
        })
